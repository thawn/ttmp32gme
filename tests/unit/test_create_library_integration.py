...
class TestCreateLibraryEntryIntegration:
    ...
    def test_create_library_entry_with_audio_and_cover(
        self, db, library_path, test_files
    ):
    ...
    def test_create_library_entry_multiple_audio_files(
        self, db, library_path, test_files
    ):
    ...
    def test_create_library_entry_validation_enforced(
        self, db, library_path, test_files
    ):
    ...
    def test_create_library_entry_separate_cover_precedence(
        self, db, library_path, test_files
    ):
