...
my %file_list = (
	...
	file('..','build','mac','ttmp32gme.app','Contents','Info.plist')->stringify() => '(ttmp32gme |<string>)\d\.\d\.\d( Copyright|</string>)',
	file('..','build','mac','ttmp32gme.app','Contents','Resources','English.lproj','InfoPlist.strings')->stringify() => '(CFBundleShortVersionString = "|ttmp32gme version )[\d\.]*(";| Copyright)',
);
